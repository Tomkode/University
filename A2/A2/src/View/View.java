                                        ...
                                        new CompStmt(new VarDeclStmt("d", new BoolType()),
                                                new CompStmt(new AssignStmt("b", new ValueExp(new BoolValue(true))),
                                                        new CompStmt(new AssignStmt("c", new ValueExp(new BoolValue(false))),
                                                                new CompStmt(new AssignStmt("d", new LogicExp(1, new VarExp("b"), new VarExp("c"))),
                                                                        new CompStmt(new IfStmt(new VarExp("d"), new AssignStmt("a", new ArithExp(4,new ArithExp(3, new VarExp("a"), new ValueExp(new IntValue(15))) , new ValueExp(new IntValue(2)))), new AssignStmt("a", new ArithExp(3, new ArithExp(4, new VarExp("a"), new ValueExp(new IntValue(2))) , new ValueExp(new IntValue(10)))) ),
